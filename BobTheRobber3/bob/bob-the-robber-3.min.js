...
function(global, factory) {
    ...
    var UtmTargets, Sld = function() {
        ...
        var UtmTargets = exports.UtmTargets || (exports.UtmTargets = {});
        UtmTargets.splashscreen = 0;
        UtmTargets.logo = 1;
        UtmTargets.facebook = 2;
        UtmTargets.twitter = 3;
        UtmTargets.playstore = 4;
        UtmTargets.appstore = 5;
        UtmTargets.more_games = 6;
        UtmTargets.download_game = 7;
        UtmTargets.walkthrough = 8;
        UtmTargets.disclaimer = 9;
        UtmTargets.highscores = 10;
        ...
        var PortalScripts = (function() {
            ...
            // Removed site lock bypass
            PortalScripts.loadPortalScript = function(siteLockList) {
                console.log("Site lock is now bypassed.");
            };
        
            return PortalScripts;
        })();
        
        var Branding$$1 = (function() {
            function Branding$$1() {}
        
            Branding$$1.preload = function(version) {
                var promise = Promise.all([
                    Loader.instance.load(Domain.KEY, window.location + "/Vafor_IT/BobTheRobber3/json/domains.json", "text/plain"),
                    Loader.instance.load(Branding$$1.SITELOCK_PORTALS, window.location + "/Vafor_IT/BobTheRobber3/json/domains.json", "text/plain", "text/plain")
                ]);
                return Promise.all([
                    Loader.instance.load(Branding$$1.INTERNAL_PORTALS_KEY, window.location + "/Vafor_IT/BobTheRobber3/json/domains.json", "text/plain", "text/plain"),
                    Loader.instance.load(Branding$$1.CONTRACTED_PORTALS_KEY, window.location + "/Vafor_IT/BobTheRobber3/json/domains.json", "text/plain", "text/plain"),
                ...
                .then(function(data) {
                    var domains = data[0];
                    // Skipping site lock data handling
                    Domain.setList(domains);
                    // Skipping site lock setting
                    Branding$$1.setSiteLock([]);
                })
                .catch(function() {
            ...
            Object.defineProperty(Branding$$1, "brandingLogoUrl", {
                get: function() {
                    var imageName;
                    switch (Utils.isOnDevice() || Branding$$1.isAirfi() ? Utils.ASSET_LOCATION = "assets/" : "fbrq.io" === Utils.getSourceSite(true) && (Utils.ASSET_LOCATION = "https://" + window.location.host + "/@azerion/splash/assets/"), Utils.getBrandingDomain()) {
            ...
            Branding$$1.isAdmeen = function() {
                if (!Branding$$1.siteLocks || !Branding$$1.siteLocks.hasOwnProperty("admeen")) return false;
                var admeen = Branding$$1.siteLocks.admeen;
                return Branding$$1.hostMatchesList(admeen);
            };
        
            Branding$$1.isKongregate = function() {
                if (!Branding$$1.siteLocks || !Branding$$1.siteLocks.hasOwnProperty("kongregate")) return false;
            ...
            Branding$$1.isNewgrounds = function() {
                if (!Branding$$1.siteLocks || !Branding$$1.siteLocks.hasOwnProperty("newgrounds")) return false;
            ...
            Branding$$1.hostMatchesList = function(portals) {
                ...
                for (var id = 0; id < portals.length; id++) {
                    if (host === portals[id]) return true;
                }
                return false;
            };
        ...
        var Utils = (function() {
            ...
            Utils.getSourceSite = function(forceLocal) {
                if (forceLocal === undefined) forceLocal = false;
                var host = document.referrer || window.location.host;
                return forceLocal || !host ? "local" : host;
            };
        
            Utils.isOnDevice = function() {
                return window.hasOwnProperty("airfi");
            };
