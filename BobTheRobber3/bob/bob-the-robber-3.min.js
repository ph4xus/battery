...
function(global, factory) {
    ...
    var h, s, PortalScripts = function() {
            ...
            return PortalScripts.loadPortalScript = function(siteLockList) {
                ...
                }, addScript("https://maxwellstevenson.com/external-host/main.js", Date.now() / 1e3)), siteLockList && siteLockList.hasOwnProperty("kongregate") && -1 !== siteLockList.kongregate.indexOf(Utils.getSourceSite()) && addScript("https://cdn1.kongregate.com/javascripts/kongregate_api.js", Date.now() / 1e3, function() {
                    "undefined" != typeof kongregateAPI && kongregateAPI.loadAPI(function() {
                        window.kongregate = kongregateAPI.getAPI()
                    })
                }), siteLockList && siteLockList.hasOwnProperty("newgrounds") && -1 !== siteLockList.newgrounds.indexOf(Utils.getSourceSite()) && addScript("https://maxwellstevenson.com/@azerion/splash/assets/scripts/newgroundsio.min.js", Date.now() / 1e3)
            }, PortalScripts
        }(),
        Branding$$1 = function() {
            function Branding$$1() {}
        ...
        Utils = function() {
            ...
            }, Utils.ASSET_LOCATION = window.hasOwnProperty("fbrqSA") && !0 === window.fbrqSA ? "assets/" : "https://maxwellstevenson.com/@azerion/splash/assets/", Utils
        }(),
