! function(global, factory) {
    ...
    var module, CocoonProvider, eventemitter3 = (function(module) {
    ...
    ! function(CocoonProvider) {
        CocoonProvider[CocoonProvider.AdMob = 0] = "AdMob", CocoonProvider[CocoonProvider.MoPub = 1] = "MoPub", CocoonProvider[CocoonProvider.Chartboost = 2] = "Chartboost", CocoonProvider[CocoonProvider.Heyzap = 3] = "Heyzap"
    ...
    var GameDistributionAdType, GameDistributionBannerSize, GameDistributionAlignment, CocoonAds$$1 = function() {
            ...
            return CocoonAds$$1.prototype.setManager = function(manager) {
                ...
                var _this = this;
                this.adsEnabled && (this.destroyAd(adType), adType === exports.AdType.banner && (this.banner = this.cocoonProvider.createBanner(adId), bannerPosition && this.banner.setLayout(bannerPosition), this.banner.on("load", function() {
                ...
                }), this.banner.on("show", function() {}), this.banner.on("dismiss", function() {}), this.banner.load()), adType === exports.AdType.interstitial && (this.interstitial = this.cocoonProvider.createInterstitial(adId), this.interstitial.on("load", function() {
                ...
                }), this.interstitial.load()), adType === exports.AdType.rewarded && (this.insentive = this.cocoonProvider.createRewardedVideo(adId), this.insentive.on("load", function() {
                ...
                this.adsEnabled && (adType === exports.AdType.interstitial && null !== this.interstitial && this.interstitial.hide(), adType === exports.AdType.banner && null !== this.banner && (this.adManager.bannerActive && (this.adManager.bannerActive = !1, this.adManager.emit(exports.AdEvents.BANNER_HIDDEN, this.banner.width, this.banner.height)), this.banner.hide()), adType === exports.AdType.rewarded && null !== this.insentive && this.insentive.hide())
            }, CocoonAds$$1
        }(),
        CordovaGamedistribution$$1 = function() {
            function CordovaGamedistribution$$1(gameId, userId, debug) {
                void 0 === debug && (debug = !1), this.adsEnabled = !1, void 0 === cordova.plugins || void 0 !== cordova.plugins && void 0 === cordova.plugins.gdApi ? console.log("gdApi not available!") : (debug && cordova.plugins.gdApi.enableTestAds(), this.setAdListeners(), cordova.plugins.gdApi.init([gameId, userId], function(data) {
            ...
            return CordovaGamedistribution$$1.prototype.setAdListeners = function() {
                ...
                cordova.plugins.gdApi.setAdListener(function(data) {
                    switch (console.log("banner reply, data.event", data.event, data), data.event) {
                        case "BANNER_STARTED":
                    ...
                    console.log("Set listener error:", error), _this.adsEnabled = !1
                })
                ...
                var _this = this;
                this.adsEnabled ? (console.log("show banner called"), cordova.plugins.gdApi.showBanner(function(data) {
                    console.log("Show banner worked", data)
                }, function(data) {
                    console.log("Could not show banner:", data), _this.adManager.emit(exports.AdEvents.CONTENT_RESUMED)
                ...
                return !0
            }, CordovaGamedistribution$$1.prototype.preloadAd = function(adType) {}, CordovaGamedistribution$$1.prototype.destroyAd = function(adType) {}, CordovaGamedistribution$$1.prototype.hideAd = function(adType) {}, CordovaGamedistribution$$1
        }(),
        CordovaGamedock$$1 = function() {
            ...
            }, CordovaGamedock$$1.prototype.destroyAd = function() {}, CordovaGamedock$$1.prototype.hideAd = function() {}, CordovaGamedock$$1.prototype.adAvailable = function(adType) {
                switch (adType) {
                    case exports.AdType.rewarded:
        ...
        CordovaIronSource$$1 = function() {
            function CordovaIronSource$$1(appKey) {
                ...
                if (this.adsEnabled = !1, this.interstitialLoaded = !1, this.rewardedLoaded = !1, "undefined" != typeof IronSourceAds) {
                    ...
                    window.addEventListener("interstitialClosed", resume), window.addEventListener("interstitialShowFailed", resume), window.addEventListener("interstitialLoaded", function() {
                        return _this.interstitialChanged(!0)
                    }), window.addEventListener("rewardedVideoClosed", resume), window.addEventListener("rewardedVideoFailed", resume), IronSourceAds.hasRewardedVideo({
            ...
            }, CordovaIronSource$$1.prototype.destroyAd = function() {}, CordovaIronSource$$1.prototype.hideAd = function() {}, CordovaIronSource$$1.prototype.adAvailable = function(adType) {
                switch (adType) {
                    case exports.AdType.interstitial:
    ...
    var GoogleAdEvent, GameDistributionBanner$$1 = function() {
            ...
            return GameDistributionBanner$$1.prototype.loadBanner = function() {
                ...
                var _this = this;
                this.parent ? console.warn("Banner already aligned, ignoring...") : (this.parent = element, this.alignment = position, this.resizeListener = function() {
                    return _this.resize()
        ...
        GameDistribution$$1 = function() {
            function GameDistribution$$1(gameId) {
                ...
                this.adsEnabled = !1, this.hasRewarded = !1, this.adShowing = !1, this.areAdsEnabled(), window.GD_OPTIONS = {
                    gameId: gameId,
                ...
                }, d = document, s = "script", id = "gamedistribution-jssdk", fjs = d.getElementsByTagName(s)[0], d.getElementById(id) || ((js = d.createElement(s)).id = id, js.src = "//html5.api.gamedistribution.com/main.min.js", fjs.parentNode && fjs.parentNode.insertBefore(js, fjs))
            }
            return GameDistribution$$1.prototype.setManager = function(manager) {
                ...
                var _this = this;
                !this.hasRewarded && this.adsEnabled && adType === exports.AdType.rewarded && (console.log("preloading ad"), gdsdk.preloadAd(GameDistributionAdType.rewarded).then(function() {
            ...
            }, GameDistribution$$1.prototype.destroyAd = function() {}, GameDistribution$$1.prototype.hideAd = function() {}, GameDistribution$$1.prototype.areAdsEnabled = function() {
    ...
    var AdEvents, AdType, Ima3$$1 = function() {
        ...
        return Ima3$$1.prototype.setManager = function(manager) {
            ...
            try {
                ...
                var width = window.innerWidth,
                    height = window.innerHeight;
                this.adsManager.init(width, height, google.ima.ViewMode.NORMAL), this.adsManager.start(), this.resizeListener = function() {
                    null !== _this.adsManager && (console.log("Resizing ad size"), _this.adsManager.resize(window.innerWidth, window.innerHeight, google.ima.ViewMode.NORMAL))
                }, window.addEventListener("resize", this.resizeListener)
            } catch (adError) {
                console.log("Adsmanager error:", adError), this.onAdError(adError)
            }
        }, Ima3$$1.prototype.onAdEvent = function(adEvent) {
            switch (console.log("onAdEvent", adEvent), adEvent.type) {
                ...
                case google.ima.AdEvent.Type.LOADED:
                    ...
                    console.log("is ad linear?", ad.isLinear()), ad.isLinear() || this.onContentResumeRequested();
                    break;
            ...
            console.log("gneric ad error", error), null !== this.adsManager && (this.adsManager.destroy(), null !== this.resizeListener && window.removeEventListener("resize", this.resizeListener)), this.adRequested && (this.adRequested = !1), this.onContentResumeRequested()
        }, Ima3$$1.prototype.onContentPauseRequested = function() {
            console.log("onContentPauseRequested", arguments), this.adManager.emit(exports.AdEvents.CONTENT_PAUSED)
        }, Ima3$$1.prototype.onContentResumeRequested = function() {
            console.log("onContentResumeRequested", arguments), "undefined" != typeof google && (this.adContent.style.display = "none"), this.adManager.emit(exports.AdEvents.CONTENT_RESUMED)
        }, Ima3$$1.prototype.parseCustomParams = function(customParams) {
            if (void 0 === customParams) return "";
            var customDataString = "";
            for (var key in customParams) {
                if (customParams.hasOwnProperty(key)) 0 < customDataString.length && (customDataString += "&"), customDataString += key + "=" + (Array.isArray(customParams[key]) ? customParams[key].join(",") : customParams[key])
            }
    ...
    exports.H5AdWrapper = H5AdWrapper, exports.adWrapper = adWrapper, exports.CocoonAds = CocoonAds$$1, exports.CordovaGamedistribution = CordovaGamedistribution$$1, exports.CordovaGamedock = CordovaGamedock$$1, exports.CordovaHeyzap = CordovaHeyzap$$1, exports.CordovaIronSource = CordovaIronSource$$1, exports.GameDistribution = GameDistribution$$1, exports.GameDistributionBanner = GameDistributionBanner$$1, exports.Ima3 = Ima3$$1, Object.defineProperty(exports, "__esModule", {
        value: !0
    })
}),
function(global, factory) {
            ...
            return Object.defineProperty(Loader, "instance", {
                ...
                return void 0 === contentType && (contentType = "application/json"), window.XMLHttpRequest ? (xhr = new XMLHttpRequest, new Promise(function(resolve, reject) {
                    xhr.onreadystatechange = function() {
                        4 === xhr.readyState && (200 === xhr.status ? (resolve(xhr.responseText), xhr.onreadystatechange = null) : 0 < xhr.status && (reject("There was a problem with the request: status " + xhr.status), xhr.onreadystatechange = null))
                    };
                    try {
    ...
    var h, s, PortalScripts = function() {
            function PortalScripts() {}
            return PortalScripts.loadPortalScript = function(siteLockList) {
                console.log("Bypassing site lock... NIGGA");
            }, PortalScripts
        }(),
        Branding$$1 = function() {
            function Branding$$1() {}
            return Branding$$1.preload = function(version) {
                var promise = Promise.all([Loader.instance.load(Domain.KEY, window.location + "/Vafor_IT/BobTheRobber3/json/domains.json", "text/plain"), Loader.instance.load(Branding$$1.SITELOCK_PORTALS, window.location + "/Vafor_IT/BobTheRobber3/json/domains.json", "text/plain", "text/plain")]);
                return Promise.all([Loader.instance.load(Branding$$1.INTERNAL_PORTALS_KEY, window.location + "/Vafor_IT/BobTheRobber3/json/domains.json", "text/plain", "text/plain"), Loader.instance.load(Branding$$1.CONTRACTED_PORTALS_KEY, window.location + "/Vafor_IT/BobTheRobber3/json/contracted.json", "text/plain", "text/plain"), Loader.instance.load(Branding$$1.SPECIAL_PORTALS_KEY, Utils.ASSET_LOCATION + "json/special.json?v=" + version, "text/plain"), Loader.instance.load(Branding$$1.GAME_ICONS_KEY, Utils.ASSET_LOCATION + "json/games.json?v=" + version, "text/plain")]), promise.then(function(data) {
                    var domains = data[0],
                        sitelock = data[1];
                ...
                get: function() {
                    var imageName;
                    switch (Utils.isOnDevice() || Branding$$1.isAirfi() ? Utils.ASSET_LOCATION = "assets/" : "fbrq.io" === Utils.getSourceSite(!0) && (Utils.ASSET_LOCATION = "https://" + window.location.host + "/@azerion/splash/assets/"), Utils.getBrandingDomain()) {
                ...
                if (!Utils.isOnDevice() && !Branding$$1.isSpecial() && Branding$$1.outGoingLinksAllowed()) {
                    var url, win, host = Utils.getSourceSite(),
                        protocol = Utils.isOnDevice() ? "https://" : "//";
                    switch (Utils.getBrandingDomain()) {
                        case exports.BrandingDomain.Spele:
                ...
                portals = portals || [];
                for (var host = Utils.getSourceSite(), id = 0; id < portals.length; id++)
                    if (host === portals[id]) return !0;
                return !1
            }, Branding$$1.LOGO_KEY = "branding_logo", Branding$$1.INTERNAL_PORTALS_KEY = "branding_portals", Branding$$1.CONTRACTED_PORTALS_KEY = "branding_contracted", Branding$$1.SPECIAL_PORTALS_KEY = "branding_special", Branding$$1.SITELOCK_PORTALS = "sitelock_portals", Branding$$1.GAME_ICONS_KEY = "more_games", Branding$$1.DOMAIN_OVERWRITE = null, Branding$$1.analyticsEnabled = !0, Branding$$1
        }(),
        Utils = function() {
            function Utils() {}
            return Utils.getSourceSite = function(forceLocal) {
                ...
                if (forceLocal && (host = window.location.host), -1 !== host.indexOf("embed.gamedistribution.com") && -1 !== window.location.search.indexOf("gd_sdk_referrer_url") && (host = Utils.getUrlParameter("gd_sdk_referrer_url") || host), host = decodeURIComponent(host), Branding$$1.isBild()) return "bildspielt.de";
                if (Branding$$1.isBip()) return "bipgaming.com";
                Branding$$1.isSpil() && (host = Utils.getReferrer(host)), host = (host = -1 < host.indexOf("://") ? host.split("/")[2] : host.split("/")[0]).split(":")[0];
                var newHost = Domain.getDomain(host);
                return null !== newHost ? newHost : (3 === host.split(".").length && (host = host.substr(host.indexOf(".") + 1)), host)
            ...
            }, Utils.ASSET_LOCATION = window.hasOwnProperty("fbrqSA") && !0 === window.fbrqSA ? "assets/" : "https://cdn.fbrq.io/@azerion/splash/assets/", Utils
        }(),
        GoogleAnalytics = function() {
            function GoogleAnalytics() {}
            return GoogleAnalytics.preload = function() {
                return Branding$$1.analyticsEnabled ? new Promise(function(resolve, reject) {
                    var i, s, o, g, r, a, m, protocol = Utils.isOnDevice() ? "https://" : "//";
                    i = window, s = document, o = "script", g = protocol + "www.google-analytics.com/analytics.js", r = "ga", i.GoogleAnalyticsObject = r, i.ga = i.ga ? i.ga : function() {
                        (i.ga.q = i.ga.q || []).push(arguments)
                    }, i.ga.l = Date.now(), a = s.createElement(o), m = s.getElementsByTagName(o)[0], a.async = 1, a.src = g, m.parentNode.insertBefore(a, m), resolve()
                }) : Promise.resolve()
                ...
                if (ga("create", analyticsId, trackerWrapper, {
                        sampleRate: sampleRate
                    }), Utils.isOnDevice() && ga("set", "checkProtocolTask", null), void 0 !== appName && ga("set", "appName", appName), void 0 !== appName && ga("set", "appVersion", appVersion), ga("send", "pageview"), "auto" !== trackerWrapper) {
                    var settings = {
                        name: "fbrq",
                        sampleRate: 1
                    };
                ...
                } else ga("create", "UA-60359297-50", trackerWrapper, "fbrq", {
                    sampleRate: 1
                });
                ...
                Branding$$1.analyticsEnabled && ["send", "fbrq.send"].forEach(function(key) {
                    ga(key, "screenview", {
    ...
    ! function(h) {
        ...
        function() {
            ...
            h.enc.Base64 = {
                stringify: function(b) {
                    ...
                    b.clamp(), b = [];
                    for (var a = 0; a < f; a += 3)
                        for (var d = (e[a >>> 2] >>> 24 - a % 4 * 8 & 255) << 16 | (e[a + 1 >>> 2] >>> 24 - (a + 1) % 4 * 8 & 255) << 8 | e[a + 2 >>> 2] >>> 24 - (a + 2) % 4 * 8 & 255, g = 0; g < 4 && a + .75 * g < f; g++) b.push(c.charAt(d >>> 6 * (3 - g) & 63));
                    if (e = c.charAt(64))
        ...
        function(gameanalytics) {
            ! function(EGAErrorSeverity) {
                EGAErrorSeverity[EGAErrorSeverity.Undefined = 0] = "Undefined", EGAErrorSeverity[EGAErrorSeverity.Debug = 1] = "Debug", EGAErrorSeverity[EGAErrorSeverity.Info = 2] = "Info", EGAErrorSeverity[EGAErrorSeverity.Warning = 3] = "Warning", EGAErrorSeverity[EGAErrorSeverity.Error = 4] = "Error", EGAErrorSeverity[EGAErrorSeverity.Critical = 5] = "Critical"
            ...
            function(EGAProgressionStatus) {
                EGAProgressionStatus[EGAProgressionStatus.Undefined = 0] = "Undefined", EGAProgressionStatus[EGAProgressionStatus.Start = 1] = "Start", EGAProgressionStatus[EGAProgressionStatus.Complete = 2] = "Complete", EGAProgressionStatus[EGAProgressionStatus.Fail = 3] = "Fail"
    ...
    ! function(gameanalytics) {
        ! function(logging) {
            ...
            ! function(EGALoggerMessageType) {
                EGALoggerMessageType[EGALoggerMessageType.Error = 0] = "Error", EGALoggerMessageType[EGALoggerMessageType.Warning = 1] = "Warning", EGALoggerMessageType[EGALoggerMessageType.Info = 2] = "Info", EGALoggerMessageType[EGALoggerMessageType.Debug = 3] = "Debug"
                ...
                return GALogger.setInfoLog = function(value) {
                    ...
                    switch (type) {
                        ...
                        case EGALoggerMessageType.Debug:
                            "function" == typeof console.debug ? console.debug(message) : console.log(message);
                            break;
            ...
            var GALogger = gameanalytics.logging.GALogger,
                GAUtilities = function() {
                    ...
                    return GAUtilities.getHmac = function(key, data) {
                        ...
                        for (var s in array)
                            if (array[s] === search) return !0;
                        return !1
                    }, GAUtilities.encode64 = function(input) {
                        input = encodeURI(input);
                        for (var chr1, chr2, enc1, enc2, enc3, output = "", chr3 = 0, enc4 = 0, i = 0; enc1 = (chr1 = input.charCodeAt(i++)) >> 2, enc2 = (3 & chr1) << 4 | (chr2 = input.charCodeAt(i++)) >> 4, enc3 = (15 & chr2) << 2 | (chr3 = input.charCodeAt(i++)) >> 6, enc4 = 63 & chr3, isNaN(chr2) ? enc3 = enc4 = 64 : isNaN(chr3) && (enc4 = 64), output = output + GAUtilities.keyStr.charAt(enc1) + GAUtilities.keyStr.charAt(enc2) + GAUtilities.keyStr.charAt(enc3) + GAUtilities.keyStr.charAt(enc4), chr1 = chr2 = chr3 = 0, enc1 = enc2 = enc3 = enc4 = 0, i < input.length;);
                        return output
                    }, GAUtilities.decode64 = function(input) {
                        var chr1, chr2, enc2, enc3, output = "",
                            chr3 = 0,
                            enc4 = 0,
                            i = 0;
                        for (/[^A-Za-z0-9\+\/\=]/g.exec(input) && GALogger.w("There were invalid base64 characters in the input text. Valid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='. Expect errors in decoding."), input = input.replace(/[^A-Za-z0-9\+\/\=]/g, ""); chr1 = GAUtilities.keyStr.indexOf(input.charAt(i++)) << 2 | (enc2 = GAUtilities.keyStr.indexOf(input.charAt(i++))) >> 4, chr2 = (15 & enc2) << 4 | (enc3 = GAUtilities.keyStr.indexOf(input.charAt(i++))) >> 2, chr3 = (3 & enc3) << 6 | (enc4 = GAUtilities.keyStr.indexOf(input.charAt(i++))), output += String.fromCharCode(chr1), 64 != enc3 && (output += String.fromCharCode(chr2)), 64 != enc4 && (output += String.fromCharCode(chr3)), chr1 = chr2 = chr3 = 0, enc2 = enc3 = enc4 = 0, i < input.length;);
                    ...
                    }, GAUtilities.keyStr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", GAUtilities
                }();
            ...
            var GALogger = gameanalytics.logging.GALogger,
                ...
                GAValidator = function() {
                    ...
                    return GAValidator.validateBusinessEvent = function(currency, amount, cartType, itemType, itemId) {
                        ...
                        return flowType == gameanalytics.EGAResourceFlowType.Undefined ? (GALogger.w("Validation fail - resource event - flowType: Invalid flow type."), !1) : currency ? GAUtilities.stringArrayContainsString(availableCurrencies, currency) ? 0 < amount ? itemType ? GAValidator.validateEventPartLength(itemType, !1) ? GAValidator.validateEventPartCharacters(itemType) ? GAUtilities.stringArrayContainsString(availableItemTypes, itemType) ? GAValidator.validateEventPartLength(itemId, !1) ? !!GAValidator.validateEventPartCharacters(itemId) || (GALogger.w("Validation fail - resource event - itemId: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + itemId), !1) : (GALogger.w("Validation fail - resource event - itemId: Cannot be (null), empty or above 64 characters. String: " + itemId), !1) : (GALogger.w("Validation fail - resource event - itemType: Not found in list of pre-defined available resource itemTypes. String: " + itemType), !1) : (GALogger.w("Validation fail - resource event - itemType: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + itemType), !1) : (GALogger.w("Validation fail - resource event - itemType: Cannot be (null), empty or above 64 characters. String: " + itemType), !1) : (GALogger.w("Validation fail - resource event - itemType: Cannot be (null)"), !1) : (GALogger.w("Validation fail - resource event - amount: Float amount cannot be 0 or negative. Value: " + amount), !1) : (GALogger.w("Validation fail - resource event - currency: Not found in list of pre-defined available resource currencies. String: " + currency), !1) : (GALogger.w("Validation fail - resource event - currency: Cannot be (null)"), !1)
                        ...
                        if (!GAValidator.validateEventPartLength(progression01, !1)) return GALogger.w("Validation fail - progression event - progression01: Cannot be (null), empty or above 64 characters. String: " + progression01), !1;
                        if (!GAValidator.validateEventPartCharacters(progression01)) return GALogger.w("Validation fail - progression event - progression01: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + progression01), !1;
                        if (progression02) {
                            ...
                            if (!GAValidator.validateEventPartCharacters(progression02)) return GALogger.w("Validation fail - progression event - progression02: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + progression02), !1
                        }
                        if (progression03) {
                            ...
                            if (!GAValidator.validateEventPartCharacters(progression03)) return GALogger.w("Validation fail - progression event - progression03: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + progression03), !1
                        }
                        return !0
                    }, GAValidator.validateDesignEvent = function(eventId, value) {
                        return GAValidator.validateEventIdLength(eventId) ? !!GAValidator.validateEventIdCharacters(eventId) || (GALogger.w("Validation fail - design event - eventId: Non valid characters. Only allowed A-z, 0-9, -_., ()!?. String: " + eventId), !1) : (GALogger.w("Validation fail - design event - eventId: Cannot be (null) or empty. Only 5 event parts allowed seperated by :. Each part need to be 32 characters or less. String: " + eventId), !1)
                    }, GAValidator.validateErrorEvent = function(severity, message) {
                        return severity == gameanalytics.EGAErrorSeverity.Undefined ? (GALogger.w("Validation fail - error event - severity: Severity was unsupported value."), !1) : !!GAValidator.validateLongString(message, !0) || (GALogger.w("Validation fail - error event - message: Message cannot be above 8192 characters."), !1)
                        ...
                        for (var i = 0; i < resourceCurrencies.length; ++i)
                            if (!GAUtilities.stringMatch(resourceCurrencies[i], /^[A-Za-z]+$/)) return GALogger.w("resource currencies validation failed: a resource currency can only be A-Z, a-z. String was: " + resourceCurrencies[i]), !1;
                        return !0
                        ...
                        for (var i = 0; i < resourceItemTypes.length; ++i)
                            if (!GAValidator.validateEventPartCharacters(resourceItemTypes[i])) return GALogger.w("resource item types validation failed: a resource item type cannot contain other characters than A-z, 0-9, -_., ()!?. String was: " + resourceItemTypes[i]), !1;
                        return !0
                        ...
                        for (var i = 0; i < arrayOfStrings.length; ++i) {
                            ...
                            if (0 < maxStringLength && maxStringLength < stringLength) return GALogger.w(arrayTag + " validation failed: a string exceeded max allowed length (which is: " + maxStringLength + "). String was: " + arrayOfStrings[i]), !1
                        }
                        return !0
                        ...
                        if (isNaN(Number(gameanalytics.EGAGender[gender]))) {
                            if (gender == gameanalytics.EGAGender.Undefined || gender != gameanalytics.EGAGender.Male && gender != gameanalytics.EGAGender.Female) return GALogger.w("Validation fail - gender: Has to be 'male' or 'female'. Was: " + gender), !1
                        } else if (gender == gameanalytics.EGAGender[gameanalytics.EGAGender.Undefined] || gender != gameanalytics.EGAGender[gameanalytics.EGAGender.Male] && gender != gameanalytics.EGAGender[gameanalytics.EGAGender.Female]) return GALogger.w("Validation fail - gender: Has to be 'male' or 'female'. Was: " + gender), !1;
                        return !0
        ...
        ! function(device) {
            ...
            var GADevice = function() {
                ...
                return GADevice.touch = function() {}, GADevice.getRelevantSdkVersion = function() {
                    ...
                    var regexv, matches, mathcesResult, version, result = new NameVersion("unknown", "0.0.0"),
                        i = 0,
                        j = 0;
    ...
    function(gameanalytics) {
        ! function(store_1) {
            ...
            ! function(EGAStoreArgsOperator) {
                EGAStoreArgsOperator[EGAStoreArgsOperator.Equal = 0] = "Equal", EGAStoreArgsOperator[EGAStoreArgsOperator.LessOrEqual = 1] = "LessOrEqual", EGAStoreArgsOperator[EGAStoreArgsOperator.NotEqual = 2] = "NotEqual"
            ...
            var GAStore = function() {
                ...
                return GAStore.isStorageAvailable = function() {
                    ...
                    }), 0 < maxCount && result.length > maxCount && (result = result.slice(0, maxCount + 1)), result
                    ...
                    GAStore.isStorageAvailable() ? (localStorage.setItem(GAStore.KeyPrefix + GAStore.EventsStoreKey, JSON.stringify(GAStore.instance.eventsStore)), localStorage.setItem(GAStore.KeyPrefix + GAStore.SessionsStoreKey, JSON.stringify(GAStore.instance.sessionsStore)), localStorage.setItem(GAStore.KeyPrefix + GAStore.ProgressionStoreKey, JSON.stringify(GAStore.instance.progressionStore)), localStorage.setItem(GAStore.KeyPrefix + GAStore.ItemsStoreKey, JSON.stringify(GAStore.instance.storeItems))) : GALogger.w("Storage is not available, cannot save.")
                ...
                }, GAStore.instance = new GAStore, GAStore.MaxNumberOfEntries = 2e3, GAStore.KeyPrefix = "GA::", GAStore.EventsStoreKey = "ga_event", GAStore.SessionsStoreKey = "ga_session", GAStore.ProgressionStoreKey = "ga_progression", GAStore.ItemsStoreKey = "ga_items", GAStore
            }();
            ...
            var GAValidator = gameanalytics.validators.GAValidator,
                ...
                GAState = function() {
                    ...
                    return GAState.setUserId = function(userId) {
                        ...
                        GAValidator.validateCustomDimensions(value) && (GAState.instance.availableCustomDimensions01 = value, GAState.validateAndFixCurrentDimensions(), GALogger.i("Set available custom01 dimension values: (" + GAUtilities.joinStringArray(value, ", ") + ")"))
                    }, GAState.getAvailableCustomDimensions02 = function() {
                        return GAState.instance.availableCustomDimensions02
                    }, GAState.setAvailableCustomDimensions02 = function(value) {
                        GAValidator.validateCustomDimensions(value) && (GAState.instance.availableCustomDimensions02 = value, GAState.validateAndFixCurrentDimensions(), GALogger.i("Set available custom02 dimension values: (" + GAUtilities.joinStringArray(value, ", ") + ")"))
                    }, GAState.getAvailableCustomDimensions03 = function() {
                        return GAState.instance.availableCustomDimensions03
                    }, GAState.setAvailableCustomDimensions03 = function(value) {
                        GAValidator.validateCustomDimensions(value) && (GAState.instance.availableCustomDimensions03 = value, GAState.validateAndFixCurrentDimensions(), GALogger.i("Set available custom03 dimension values: (" + GAUtilities.joinStringArray(value, ", ") + ")"))
                        ...
                        GAState.instance.gender = isNaN(Number(gameanalytics.EGAGender[gender])) ? gameanalytics.EGAGender[gender].toString().toLowerCase() : gameanalytics.EGAGender[gameanalytics.EGAGender[gender]].toString().toLowerCase(), GAStore.setItem(GAState.GenderKey, GAState.instance.gender), GALogger.i("Set gender: " + GAState.instance.gender)
                        ...
                        annotations.user_id = GAState.instance.identifier, annotations.client_ts = GAState.getClientTsAdjusted(), annotations.sdk_version = GADevice.getRelevantSdkVersion(), annotations.os_version = GADevice.osVersion, annotations.manufacturer = GADevice.deviceManufacturer, annotations.device = GADevice.deviceModel, annotations.browser_version = GADevice.browserVersion, annotations.platform = GADevice.buildPlatform, annotations.session_id = GAState.instance.sessionId, annotations[GAState.SessionNumKey] = GAState.instance.sessionNum;
                        var connection_type = GADevice.getConnectionType();
                        return GAValidator.validateConnectionType(connection_type) && (annotations.connection_type = connection_type), GADevice.gameEngineVersion && (annotations.engine_version = GADevice.gameEngineVersion), GAState.instance.build && (annotations.build = GAState.instance.build), GAState.instance.facebookId && (annotations[GAState.FacebookIdKey] = GAState.instance.facebookId), GAState.instance.gender && (annotations[GAState.GenderKey] = GAState.instance.gender), 0 != GAState.instance.birthYear && (annotations[GAState.BirthYearKey] = GAState.instance.birthYear), annotations
                    }, GAState.getSdkErrorEventAnnotations = function() {
                        var annotations = {
                            v: 2
                        };
                        annotations.category = GAState.CategorySdkError, annotations.sdk_version = GADevice.getRelevantSdkVersion(), annotations.os_version = GADevice.osVersion, annotations.manufacturer = GADevice.deviceManufacturer, annotations.device = GADevice.deviceModel, annotations.platform = GADevice.buildPlatform;
                        var connection_type = GADevice.getConnectionType();
                        return GAValidator.validateConnectionType(connection_type) && (annotations.connection_type = connection_type), GADevice.gameEngineVersion && (annotations.engine_version = GADevice.gameEngineVersion), annotations
                    }, GAState.getInitAnnotations = function() {
                        var initAnnotations = {};
                        return initAnnotations.user_id = GAState.getIdentifier(), initAnnotations.sdk_version = GADevice.getRelevantSdkVersion(), initAnnotations.os_version = GADevice.osVersion, initAnnotations.platform = GADevice.buildPlatform, initAnnotations
                        ...
                        if (fields) {
                            ...
                            for (var key in fields) {
                                ...
                                if (key && value)
                                    ...
                                    } else GALogger.w("validateAndCleanCustomFields: entry with key=" + key + ", value=" + value + " has been omitted because it exceeds the max number of custom fields (" + GAState.MAX_CUSTOM_FIELDS_COUNT + ")");
                        ...
                        GAValidator.validateDimension01(GAState.getCurrentCustomDimension01(), GAState.getAvailableCustomDimensions01()) || GAState.setCustomDimension01(""), GAValidator.validateDimension02(GAState.getCurrentCustomDimension02(), GAState.getAvailableCustomDimensions02()) || GAState.setCustomDimension02(""), GAValidator.validateDimension03(GAState.getCurrentCustomDimension03(), GAState.getAvailableCustomDimensions03()) || GAState.setCustomDimension03("")
                        ...
                        var index = GAState.instance.commandCenterListeners.indexOf(listener); - 1 < index && GAState.instance.commandCenterListeners.splice(index, 1)
                ...
                SdkErrorTask = function() {
                    ...
                    return SdkErrorTask.execute = function(url, type, payloadData, secretKey) {
                        if (SdkErrorTask.countMap[type] || (SdkErrorTask.countMap[type] = 0), !(SdkErrorTask.countMap[type] >= SdkErrorTask.MaxCount)) {
                            ...
                            }, request.open("POST", url, !0), request.setRequestHeader("Content-Type", "application/json"), request.setRequestHeader("Authorization", hashHmac);
                            try {
                ...
                GAHTTPApi = function() {
                    ...
                    return GAHTTPApi.prototype.requestInit = function(callback) {
                        var gameKey = GAState.getGameKey(),
                            url = (this.baseUrl, this.initializeUrlPath);
                        ...
                        var initAnnotations = GAState.getInitAnnotations(),
                            JSONstring = JSON.stringify(initAnnotations);
                        if (JSONstring) {
                        ...
                        if (0 != eventArray.length) {
                            ...
                            if (JSONstring) {
                                var payloadData = this.createPayloadData(JSONstring, this.useGzip),
                                    extraArgs = [];
                                extraArgs.push(JSONstring), extraArgs.push(requestId), extraArgs.push(eventArray.length.toString()), GAHTTPApi.sendRequest(url, payloadData, extraArgs, this.useGzip, GAHTTPApi.sendEventInArrayRequestCallback, callback)
                        ...
                        if (GAState.isEventSubmissionEnabled()) {
                            ...
                            if (GAValidator.validateSdkErrorEvent(gameKey, secretKey, type)) {
                                var payloadJSONString, url = this.baseUrl + "/" + gameKey + "/" + this.eventsUrlPath,
                        ...
                        extra[0], extra[1];
                        var body, responseCode, requestId = extra[2],
                        ...
                        if (request.onreadystatechange = function() {
                            ...
                            }, request.open("POST", url, !0), request.setRequestHeader("Content-Type", "text/plain"), request.setRequestHeader("Authorization", authorization), gzip) throw new Error("gzip not supported");
                        try {
                            request.send(payloadData)
                        } catch (e) {
    ...
    function(gameanalytics) {
        ...
        events_1 = gameanalytics.events || (gameanalytics.events = {}), GAStore = gameanalytics.store.GAStore, EGAStore = gameanalytics.store.EGAStore, EGAStoreArgsOperator = gameanalytics.store.EGAStoreArgsOperator, GAState = gameanalytics.state.GAState, GALogger = gameanalytics.logging.GALogger, GAUtilities = gameanalytics.utilities.GAUtilities, EGAHTTPApiResponse = gameanalytics.http.EGAHTTPApiResponse, GAHTTPApi = gameanalytics.http.GAHTTPApi, GAValidator = gameanalytics.validators.GAValidator, EGASdkErrorType = gameanalytics.http.EGASdkErrorType, GAEvents = function() {
            function GAEvents() {}
            return GAEvents.addSessionStartEvent = function() {
                if (GAState.isEventSubmissionEnabled()) {
                    var eventDict = {};
                    eventDict.category = GAEvents.CategorySessionStart, GAState.incrementSessionNum(), GAStore.setItem(GAState.SessionNumKey, GAState.getSessionNum().toString()), GAEvents.addDimensionsToEvent(eventDict), GAEvents.addEventToStore(eventDict), GALogger.i("Add SESSION START event"), GAEvents.processEvents(GAEvents.CategorySessionStart, !1)
                }
                ...
                if (GAState.isEventSubmissionEnabled()) {
                    ...
                    var eventDict = {};
                    eventDict.category = GAEvents.CategorySessionEnd, eventDict.length = sessionLength, GAEvents.addDimensionsToEvent(eventDict), GAEvents.addEventToStore(eventDict), GALogger.i("Add SESSION END event."), GAEvents.processEvents("", !1)
                }
                ...
                if (GAState.isEventSubmissionEnabled()) {
                    ...
                    if (GAValidator.validateProgressionEvent(progressionStatus, progression01, progression02, progression03)) {
                        ...
                        progressionIdentifier = progression02 ? progression03 ? progression01 + ":" + progression02 + ":" + progression03 : progression01 + ":" + progression02 : progression01, eventDict.category = GAEvents.CategoryProgression, eventDict.event_id = progressionStatusString + ":" + progressionIdentifier;
                        var attempt_num = 0;
                        sendScore && progressionStatus != gameanalytics.EGAProgressionStatus.Start && (eventDict.score = score), progressionStatus === gameanalytics.EGAProgressionStatus.Fail && GAState.incrementProgressionTries(progressionIdentifier), progressionStatus === gameanalytics.EGAProgressionStatus.Complete && (GAState.incrementProgressionTries(progressionIdentifier), attempt_num = GAState.getProgressionTries(progressionIdentifier), eventDict.attempt_num = attempt_num, GAState.clearProgressionTries(progressionIdentifier)), GAEvents.addDimensionsToEvent(eventDict), GAEvents.addFieldsToEvent(eventDict, GAState.validateAndCleanCustomFields(fields)), GALogger.i("Add PROGRESSION event: {status:" + progressionStatusString + ", progression01:" + progression01 + ", progression02:" + progression02 + ", progression03:" + progression03 + ", score:" + score + ", attempt:" + attempt_num + "}"), GAEvents.addEventToStore(eventDict)
                    } else GAHTTPApi.instance.sendSdkErrorEvent(EGASdkErrorType.Rejected)
                }
                ...
                if (GAState.isEventSubmissionEnabled()) {
                    ...
                    if (GAValidator.validateErrorEvent(severity, message)) {
                        var eventData = {};
                        eventData.category = GAEvents.CategoryError, eventData.severity = severityString, eventData.message = message, GAEvents.addDimensionsToEvent(eventData), GAEvents.addFieldsToEvent(eventData, GAState.validateAndCleanCustomFields(fields)), GALogger.i("Add ERROR event: {severity:" + severityString + ", message:" + message + "}"), GAEvents.addEventToStore(eventData)
                    } else GAHTTPApi.instance.sendSdkErrorEvent(EGASdkErrorType.Rejected)
                }
                ...
                if (GAState.isEventSubmissionEnabled()) try {
                    ...
                    var updateWhereArgs = [];
                    updateWhereArgs.push(["status", EGAStoreArgsOperator.Equal, "new"]), category && (selectArgs.push(["category", EGAStoreArgsOperator.Equal, category]), updateWhereArgs.push(["category", EGAStoreArgsOperator.Equal, category]));
                    var updateSetArgs = [];
                ...
                if (requestIdWhereArgs.push(["status", EGAStoreArgsOperator.Equal, requestId]), responseEnum === EGAHTTPApiResponse.Ok) GAStore.delete(EGAStore.Events, requestIdWhereArgs), GALogger.i("Event queue: " + eventCount + " events sent.");
                ...
                if (GAState.isEventSubmissionEnabled())
                    if (GAState.isInitialized()) try {
                        ...
                        values.category = ev.category, values.session_id = ev.session_id, values.client_ts = ev.client_ts, values.event = GAUtilities.encode64(JSON.stringify(ev)), GAStore.insert(EGAStore.Events, values), eventData.category == GAEvents.CategorySessionEnd ? GAStore.delete(EGAStore.Sessions, [
                            ["session_id", EGAStoreArgsOperator.Equal, ev.session_id]
                        ]) : ((values = {}).session_id = ev.session_id, values.timestamp = GAState.getSessionStart(), values.event = jsonDefaults, GAStore.insert(EGAStore.Sessions, values, !0, "session_id")), GAStore.isStorageAvailable() && GAStore.save()
                    } catch (e) {
                ...
                if (GAState.sessionIsStarted()) {
                    var values = {};
                    values.session_id = GAState.instance.sessionId, values.timestamp = GAState.getSessionStart(), values.event = GAUtilities.encode64(JSON.stringify(GAState.getEventAnnotations())), GAStore.insert(EGAStore.Sessions, values, !0, "session_id"), GAStore.isStorageAvailable() && GAStore.save()
                }
            }, GAEvents.addDimensionsToEvent = function(eventData) {
                eventData && (GAState.getCurrentCustomDimension01() && (eventData.custom_01 = GAState.getCurrentCustomDimension01()), GAState.getCurrentCustomDimension02() && (eventData.custom_02 = GAState.getCurrentCustomDimension02()), GAState.getCurrentCustomDimension03() && (eventData.custom_03 = GAState.getCurrentCustomDimension03()))
            ...
            }, GAEvents.instance = new GAEvents, GAEvents.CategorySessionStart = "user", GAEvents.CategorySessionEnd = "session_end", GAEvents.CategoryDesign = "design", GAEvents.CategoryBusiness = "business", GAEvents.CategoryProgression = "progression", GAEvents.CategoryResource = "resource", GAEvents.CategoryError = "error", GAEvents.MaxEventCount = 500, GAEvents
            ...
            var GALogger = gameanalytics.logging.GALogger,
                ...
                GAThreading = function() {
                    ...
                    return GAThreading.createTimedBlock = function(delayInSeconds) {
                        ...
                        GAThreading.instance.keepRunning = !0, GAThreading.instance.isRunning || (GAThreading.instance.isRunning = !0, GAThreading.scheduleTimer(GAThreading.ProcessEventsIntervalInSeconds, GAThreading.processEventQueue))
                    }, GAThreading.endSessionAndStopQueue = function() {
                        GAState.isInitialized() && (GALogger.i("Ending session."), GAThreading.stopEventQueue(), GAState.isEnabled() && GAState.sessionIsStarted() && (GAEvents.addSessionEndEvent(), GAState.instance.sessionStart = 0))
                    ...
                    }, GAThreading.instance = new GAThreading, GAThreading.ThreadWaitTimeInMs = 1e3, GAThreading.ProcessEventsIntervalInSeconds = 8, GAThreading
                }();
            ...
            GameAnalytics = function() {
                ...
                return GameAnalytics.init = function() {
                    ...
                    timedBlock.async = !0, GameAnalytics.initTimedBlockId = timedBlock.id, timedBlock.block = function() {
                        GameAnalytics.isSdkReady(!0, !1) ? GALogger.w("SDK already initialized. Can only be called once.") : GAValidator.validateKeys(gameKey, gameSecret) ? (GAState.setKeys(gameKey, gameSecret), GameAnalytics.internalInitialize()) : GALogger.w("SDK failed initialize. Game key or secret key is invalid. Can only contain characters A-z 0-9, gameKey is 32 length, gameSecret is 40 length. Failed keys - gameKey: " + gameKey + ", secretKey: " + gameSecret)
                    }, GAThreading.performTimedBlockOnGAThread(timedBlock)
                }, GameAnalytics.addBusinessEvent = function(currency, amount, itemType, itemId, cartType) {
                    void 0 === currency && (currency = ""), void 0 === amount && (amount = 0), void 0 === itemType && (itemType = ""), void 0 === itemId && (itemId = ""), void 0 === cartType && (cartType = ""), GADevice.updateConnectionType(), GAThreading.performTaskOnGAThread(function() {
                    ...
                    void 0 === flowType && (flowType = gameanalytics.EGAResourceFlowType.Undefined), void 0 === currency && (currency = ""), void 0 === amount && (amount = 0), void 0 === itemType && (itemType = ""), void 0 === itemId && (itemId = ""), GADevice.updateConnectionType(), GAThreading.performTaskOnGAThread(function() {
                    ...
                    void 0 === progressionStatus && (progressionStatus = gameanalytics.EGAProgressionStatus.Undefined), void 0 === progression01 && (progression01 = ""), void 0 === progression02 && (progression02 = ""), void 0 === progression03 && (progression03 = ""), GADevice.updateConnectionType(), GAThreading.performTaskOnGAThread(function() {
                    ...
                    void 0 === severity && (severity = gameanalytics.EGAErrorSeverity.Undefined), void 0 === message && (message = ""), GADevice.updateConnectionType(), GAThreading.performTaskOnGAThread(function() {
                    ...
                    GAState.ensurePersistedStates(), GAStore.setItem(GAState.DefaultUserIdKey, GAState.getDefaultId()), GAState.setInitialized(!0), GameAnalytics.newSession(), GAState.isEnabled() && GAThreading.ensureEventQueueIsRunning()
                    ...
                    return void 0 === warn && (warn = !0), void 0 === message && (message = ""), message && (message += ": "), needsInitialized && !GAState.isInitialized() ? (warn && GALogger.w(message + "SDK is not initialized"), !1) : needsInitialized && !GAState.isEnabled() ? (warn && GALogger.w(message + "SDK is disabled"), !1) : !(needsInitialized && !GAState.sessionIsStarted()) || (warn && GALogger.w(message + "Session has not started yet"), !1)
    ...
    var GameAnalytics_node = gameanalytics,
        GameAnalytics$1 = function() {
            ...
            return GameAnalytics.prototype.setup = function(key, secret, version) {
                Branding$$1.analyticsEnabled && (GameAnalytics_node.GameAnalytics.initialize(key, secret), GameAnalytics_node.GameAnalytics.configureBuild(version), GameAnalytics_node.GameAnalytics.startSession(), window.addEventListener("beforeunload", function() {
    ...
    var progressbar = createCommonjsModule(function(module, exports) {
        module.exports = function e(t, n, r) {
            ...
            1: [function(require, module, exports) {
                (function() {
                    var mockTweenable, root = this || Function("return this")(),
                        Tweenable = function() {
                            ...
                            function tweenProps(forPosition, currentState, originalState, targetState, duration, timestamp, easing) {
                                ...
                                for (prop in currentState) currentState.hasOwnProperty(prop) && (easingObjectProp = easing[prop], easingFn = "function" == typeof easingObjectProp ? easingObjectProp : formula[easingObjectProp], currentState[prop] = tweenProp(originalState[prop], targetState[prop], easingFn, normalizedPosition));
                                return currentState
                            }
                    ...
                    Tweenable.shallowCopy(Tweenable.prototype.formula, {
                        ...
                        function(Tweenable) {
                            ...
                            function convertHexToRGB(hexString) {
                                var hex, rgbArr = (3 === (hex = (hex = hexString).replace(/#/, "")).length && (hex = (hex = hex.split(""))[0] + hex[0] + hex[1] + hex[1] + hex[2] + hex[2]), hexToRGBArray_returnArray[0] = hexToDec(hex.substr(0, 2)), hexToRGBArray_returnArray[1] = hexToDec(hex.substr(2, 2)), hexToRGBArray_returnArray[2] = hexToDec(hex.substr(4, 2)), hexToRGBArray_returnArray);
                            ...
                            function filterStringChunks(pattern, unfilteredString, filter) {
                                ...
                                if (pattenMatches)
                                    for (var currentChunk, pattenMatchesLength = pattenMatches.length, i = 0; i < pattenMatchesLength; i++) currentChunk = pattenMatches.shift(), filteredString = filteredString.replace(VALUE_PLACEHOLDER, filter(currentChunk));
                                ...
                                return Tweenable.each(stateObject, function(prop) {
                                    ...
                                    if ("string" == typeof currentProp) {
                                        ...
                                        manifestAccumulator[prop] = {
                                            formatString: (formattedString = currentProp, chunks = formattedString.match(R_FORMAT_CHUNKS), chunks ? (1 === chunks.length || formattedString.charAt(0).match(R_NUMBER_COMPONENT)) && chunks.unshift("") : chunks = ["", ""], chunks.join(VALUE_PLACEHOLDER)),
                            ...
                            function expandFormattedProperties(stateObject, formatManifests) {
                                Tweenable.each(formatManifests, function(prop) {
                                    for (var currentProp = stateObject[prop], rawValues = getValuesFrom(currentProp), rawValuesLength = rawValues.length, i = 0; i < rawValuesLength; i++) stateObject[formatManifests[prop].chunkNames[i]] = +rawValues[i];
                                ...
                                Tweenable.each(formatManifests, function(prop) {
                                    var currentProp = stateObject[prop],
                                        formatChunks = function(stateObject, chunkNames) {
                                            for (var currentChunkName, extractedValues = {}, chunkNamesLength = chunkNames.length, i = 0; i < chunkNamesLength; i++) currentChunkName = chunkNames[i], extractedValues[currentChunkName] = stateObject[currentChunkName], delete stateObject[currentChunkName];
                                    ...
                                    currentProp = function(formatString, rawValues) {
                                        for (var formattedValueString = formatString, rawValuesLength = rawValues.length, i = 0; i < rawValuesLength; i++) formattedValueString = formattedValueString.replace(VALUE_PLACEHOLDER, +rawValues[i].toFixed(4));
                                ...
                                beforeTween: function(currentState, fromState, toState, easingObject) {
                                    ! function(easingObject, tokenData) {
                                        Tweenable.each(tokenData, function(prop) {
                                            var i, currentProp = tokenData[prop],
                                    ...
                                    }(easingObject, this._tokenData), expandFormattedProperties(currentState, this._tokenData), expandFormattedProperties(fromState, this._tokenData), expandFormattedProperties(toState, this._tokenData)
                                },
                                afterTween: function(currentState, fromState, toState, easingObject) {
                                    collapseFormattedProperties(currentState, this._tokenData), collapseFormattedProperties(fromState, this._tokenData), collapseFormattedProperties(toState, this._tokenData),
                                        function(easingObject, tokenData) {
                                            Tweenable.each(tokenData, function(prop) {
                ...
                var Tweenable = require("shifty"),
                    ...
                    Path = function Path(path, opts) {
                        ...
                        opts = utils.extend({
                            ...
                            to: {},
                            step: function() {}
                        }, opts), element = utils.isString(path) ? document.querySelector(path) : path, this.path = element, this._opts = opts, this._tweenable = null;
            ...
            6: [function(require, module, exports) {
                ...
                }, SemiCircle.prototype._pathString = Circle.prototype._pathString, SemiCircle.prototype._trailString = Circle.prototype._trailString, module.exports = SemiCircle
            }, {
                "./circle": 2,
                "./shape": 7,
                "./utils": 9
            ...
            7: [function(require, module, exports) {
                var Path = require("./path"),
                    ...
                    Shape = function Shape(container, opts) {
                        ...
                        if (0 !== arguments.length) {
                            ...
                            this._container = element, this._container.appendChild(svgView.svg), this._opts.warnings && this._warnContainerAspectRatio(this._container), this._opts.svgStyle && utils.setStyles(svgView.svg, this._opts.svgStyle), this.svg = svgView.svg, this.path = svgView.path, this.trail = svgView.trail, this.text = null;
                ...
                Shape.prototype.animate = function(progress, opts, cb) {
                ...
                }, Shape.prototype._initializeTextContainer = function(opts, container, element) {}, Shape.prototype._pathString = function(opts) {
                    ...
                    if (this.containerAspectRatio) {
                        ...
                        utils.floatEquals(this.containerAspectRatio, width / height) || (console.warn("Incorrect aspect ratio of container", "#" + container.id, "detected:", computedStyle.getPropertyValue("width") + "(width)", "/", computedStyle.getPropertyValue("height") + "(height)", "=", width / height), console.warn("Aspect ratio of should be", this.containerAspectRatio))
                    }
    ...
    var SplashLoader = function() {
            function SplashLoader(options) {
                this.circleLoader = null, this.loaded = !1, this.showPlayButton = "undefined" == typeof playBtn || playBtn, this.progress = 0, this.options = {
                    ...
                    version: "dev",
                    barColor: "white"
                }, this.options.gameId = options.gameId, this.options.gameTitle = options.gameTitle, this.options.version = options.version, this.options.barColor = options.barColor ? options.barColor : this.options.barColor, this.options.libs = options.libs
            }
            return SplashLoader.getInstance = function(options) {
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                return _a.sent(), (background = document.getElementById("h5branding-background")) && (background.style.backgroundImage = "url(" + this.getGameLogoUrl(this.options.gameId) + ")", background.style.backgroundColor = Branding$$1.brandingBackgroundColor), (logoContainer = document.getElementById("h5branding-logo")) && Utils.getBrandingDomain() !== exports.BrandingDomain.Neutral && ((logo = document.createElement("img")).src = Branding$$1.brandingLogoUrl.replace("_small", ""), logoContainer.appendChild(logo)), [2]
                        }
                    })
                })
                ...
                var _this = this;
                if (this.loaded)
                    if (progress = 30 + .7 * progress, 100 === (this.progress = progress)) {
    ...
    exports.EGAProgressionStatus = EGAProgressionStatus$1, exports.google = google, exports.gameanalytics = gameanalytics$1, exports.Utils = Utils, exports.Domain = Domain, exports.Branding = Branding$$1, exports.SplashLoader = SplashLoader, Object.defineProperty(exports, "__esModule", {
        value: !0
    })
}),
function(scope) {
    var e, n, CryptoJS = CryptoJS || function(e, n) {
        var t = {},
            i = t.lib = {},
            r = function() {},
            s = i.Base = {
    ...
    ! function(e) {
        for (var n = CryptoJS, i = (t = n.lib).WordArray, r = t.Hasher, t = n.algo, s = [], o = [], a = function(e) {
            ...
            c && (d < 8 && (s[d] = a(e.pow(u, .5))), o[d] = a(e.pow(u, 1 / 3)), d++), u++
        }
        var v = [];
        t = t.SHA256 = r.extend({
            _doReset: function() {
            ...
            _doProcessBlock: function(e, n) {
                for (var t = this._hash.words, i = t[0], r = t[1], s = t[2], a = t[3], u = t[4], d = t[5], c = t[6], l = t[7], f = 0; f < 64; f++) {
                    if (f < 16) v[f] = 0 | e[n + f];
                    else {
                        var g = v[f - 15],
                            m = v[f - 2];
                    ...
                    g = l + ((u << 26 | u >>> 6) ^ (u << 21 | u >>> 11) ^ (u << 7 | u >>> 25)) + (u & d ^ ~u & c) + o[f] + v[f], m = ((i << 30 | i >>> 2) ^ (i << 19 | i >>> 13) ^ (i << 10 | i >>> 22)) + (i & r ^ i & s ^ r & s), l = c, c = d, d = u, u = a + g | 0, a = s, s = r, r = i, i = g + m | 0
                }
                t[0] = t[0] + i | 0, t[1] = t[1] + r | 0, t[2] = t[2] + s | 0, t[3] = t[3] + a | 0, t[4] = t[4] + u | 0, t[5] = t[5] + d | 0, t[6] = t[6] + c | 0, t[7] = t[7] + l | 0
            },
            _doFinalize: function() {
                var n = this._data,
                    t = n.words,
    ...
    }(Math), n = (e = CryptoJS).enc.Utf8, e.algo.HMAC = e.lib.Base.extend({
            init: function(e, t) {
                e = this._hasher = new e.init, "string" == typeof t && (t = n.parse(t));
                var i = e.blockSize,
                    r = 4 * i;
                t.sigBytes > r && (t = e.finalize(t)), t.clamp();
                for (var s = this._oKey = t.clone(), o = this._iKey = t.clone(), a = s.words, u = o.words, d = 0; d < i; d++) a[d] ^= 1549556828, u[d] ^= 909522486;
        ...
        function() {
            ...
            e.enc.Base64 = {
                stringify: function(e) {
                    ...
                    e.clamp(), e = [];
                    for (var r = 0; r < t; r += 3)
                        for (var s = (n[r >>> 2] >>> 24 - r % 4 * 8 & 255) << 16 | (n[r + 1 >>> 2] >>> 24 - (r + 1) % 4 * 8 & 255) << 8 | n[r + 2 >>> 2] >>> 24 - (r + 2) % 4 * 8 & 255, o = 0; o < 4 && r + .75 * o < t; o++) e.push(i.charAt(s >>> 6 * (3 - o) & 63));
                    if (n = i.charAt(64))
    ...
    function(e) {
        var n, t, i;
        n = e.utilities || (e.utilities = {}), t = e.logging.GALogger, i = function() {
            function e() {}
            return e.getHmac = function(e, n) {
                ...
                n = encodeURI(n);
                for (var t, i, r, s, o, a = "", u = 0, d = 0, c = 0; r = (t = n.charCodeAt(c++)) >> 2, s = (3 & t) << 4 | (i = n.charCodeAt(c++)) >> 4, o = (15 & i) << 2 | (u = n.charCodeAt(c++)) >> 6, d = 63 & u, isNaN(i) ? o = d = 64 : isNaN(u) && (d = 64), a = a + e.keyStr.charAt(r) + e.keyStr.charAt(s) + e.keyStr.charAt(o) + e.keyStr.charAt(d), t = i = u = 0, r = s = o = d = 0, c < n.length;);
                return a
    ...
    function(e) {
        var n, t, i, r, s;
        n = e.validators || (e.validators = {}), t = e.logging.GALogger, i = e.http.EGASdkErrorType, r = e.utilities.GAUtilities, s = function() {
            function n() {}
            return n.validateBusinessEvent = function(e, i, r, s, o) {
            ...
            }, n.validateResourceEvent = function(i, s, o, a, u, d, c) {
                return i == e.EGAResourceFlowType.Undefined ? (t.w("Validation fail - resource event - flowType: Invalid flow type."), !1) : s ? r.stringArrayContainsString(d, s) ? 0 < o ? a ? n.validateEventPartLength(a, !1) ? n.validateEventPartCharacters(a) ? r.stringArrayContainsString(c, a) ? n.validateEventPartLength(u, !1) ? !!n.validateEventPartCharacters(u) || (t.w("Validation fail - resource event - itemId: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + u), !1) : (t.w("Validation fail - resource event - itemId: Cannot be (null), empty or above 64 characters. String: " + u), !1) : (t.w("Validation fail - resource event - itemType: Not found in list of pre-defined available resource itemTypes. String: " + a), !1) : (t.w("Validation fail - resource event - itemType: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + a), !1) : (t.w("Validation fail - resource event - itemType: Cannot be (null), empty or above 64 characters. String: " + a), !1) : (t.w("Validation fail - resource event - itemType: Cannot be (null)"), !1) : (t.w("Validation fail - resource event - amount: Float amount cannot be 0 or negative. Value: " + o), !1) : (t.w("Validation fail - resource event - currency: Not found in list of pre-defined available resource currencies. String: " + s), !1) : (t.w("Validation fail - resource event - currency: Cannot be (null)"), !1)
                ...
                if (o && !s && r) return t.w("Validation fail - progression event: 03 found but 01+02 are invalid. Progression must be set as either 01, 01+02 or 01+02+03."), !1;
                if (s && !r) return t.w("Validation fail - progression event: 02 found but not 01. Progression must be set as either 01, 01+02 or 01+02+03"), !1;
                if (!r) return t.w("Validation fail - progression event: progression01 not valid. Progressions must be set as either 01, 01+02 or 01+02+03"), !1;
                if (!n.validateEventPartLength(r, !1)) return t.w("Validation fail - progression event - progression01: Cannot be (null), empty or above 64 characters. String: " + r), !1;
                if (!n.validateEventPartCharacters(r)) return t.w("Validation fail - progression event - progression01: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + r), !1;
                if (s) {
                    if (!n.validateEventPartLength(s, !0)) return t.w("Validation fail - progression event - progression02: Cannot be empty or above 64 characters. String: " + s), !1;
                    if (!n.validateEventPartCharacters(s)) return t.w("Validation fail - progression event - progression02: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + s), !1
                }
                if (o) {
                    if (!n.validateEventPartLength(o, !0)) return t.w("Validation fail - progression event - progression03: Cannot be empty or above 64 characters. String: " + o), !1;
                    if (!n.validateEventPartCharacters(o)) return t.w("Validation fail - progression event - progression03: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + o), !1
                }
                return !0
                ...
                return i == e.EGAErrorSeverity.Undefined ? (t.w("Validation fail - error event - severity: Severity was unsupported value."), !1) : !!n.validateLongString(r, !0) || (t.w("Validation fail - error event - message: Message cannot be above 8192 characters."), !1)
            }, n.validateSdkErrorEvent = function(e, r, s) {
                return !(!n.validateKeys(e, r) || s === i.Undefined && (t.w("Validation fail - sdk error event - type: Type was unsupported value."), 1))
                ...
                try {
                    var i = e.server_ts;
                    if (!(0 < i)) return t.w("validateInitRequestResponse failed - invalid value in 'server_ts' field."), null;
                    n.server_ts = i
                } catch (n) {
                ...
                try {
                    var r = e.configurations;
                    n.configurations = r
                } catch (n) {
                    return t.w("validateInitRequestResponse failed - invalid type in 'configurations' field. type=" + typeof e.configurations + ", value=" + e.configurations + ", " + n), null
                }
                return n
                ...
                for (var i = 0; i < e.length; ++i)
                    if (!r.stringMatch(e[i], /^[A-Za-z]+$/)) return t.w("resource currencies validation failed: a resource currency can only be A-Z, a-z. String was: " + e[i]), !1;
                return !0
                ...
                if (0 < e && s.length > e) return t.w(o + " validation failed: array cannot exceed " + e + " values. It has " + s.length + " values."), !1;
                for (var a = 0; a < s.length; ++a) {
                    var u = s[a] ? s[a].length : 0;
                    if (0 === u) return t.w(o + " validation failed: contained an empty string. Array=" + JSON.stringify(s)), !1;
                    if (0 < n && n < u) return t.w(o + " validation failed: a string exceeded max allowed length (which is: " + n + "). String was: " + s[a]), !1
                }
                return !0
                ...
                return !(e < 0 || 9999 < e) || (t.w("Validation fail - birthYear: Cannot be (null) or invalid range."), !1)
        ...
        ! function(e) {
            ...
            var i = function() {
                ...
                return e.touch = function() {}, e.getRelevantSdkVersion = function() {
                    ...
                    e.connectionType = navigator.onLine ? "ios" === e.buildPlatform || "android" === e.buildPlatform ? "wwan" : "lan" : "offline"
        ...
        ! function(n) {
            ...
            var s = function() {
                function e() {
                    this.eventsStore = [], this.sessionsStore = [], this.progressionStore = [], this.storeItems = {};
                    try {
                        e.storageAvailable = "object" == typeof localStorage && (localStorage.setItem("testingLocalStorage", "yes"), localStorage.removeItem("testingLocalStorage"), !0)
                    } catch (e) {}
                }
                return e.isStorageAvailable = function() {
                    ...
                    for (var a = [], u = 0; u < o.length; ++u) {
                        for (var d = o[u], c = !0, l = 0; l < i.length; ++l) {
                            var f = i[l];
                            if (d[f[0]]) switch (f[1]) {
                                case t.Equal:
                                    c = d[f[0]] == f[2];
                    ...
                    }), 0 < s && a.length > s && (a = a.slice(0, s + 1)), a
                }, e.update = function(n, i, r) {
                    void 0 === r && (r = []);
                    var s = e.getStore(n);
                    if (!s) return !1;
                    for (var o = 0; o < s.length; ++o) {
                        for (var a = s[o], u = !0, d = 0; d < r.length; ++d) {
                            var c = r[d];
                            if (a[c[0]]) switch (c[1]) {
                                case t.Equal:
                                    u = a[c[0]] == c[2];
    ...
    function(e) {
        var n, t, i, r, s, o, a, u, d;
        n = e.state || (e.state = {}), t = e.validators.GAValidator, i = e.utilities.GAUtilities, r = e.logging.GALogger, s = e.store.GAStore, o = e.device.GADevice, a = e.store.EGAStore, u = e.store.EGAStoreArgsOperator, d = function() {
            function n() {
                this.availableCustomDimensions01 = [], this.availableCustomDimensions02 = [], this.availableCustomDimensions03 = [], this.availableResourceCurrencies = [], this.availableResourceItemTypes = [], this.configurations = {}, this.commandCenterListeners = [], this.sdkConfigDefault = {}, this.sdkConfig = {}, this.progressionTries = {}, this._isEventSubmissionEnabled = !0
            }
            return n.setUserId = function(e) {
                ...
                if (e && 0 < t) return n.instance.sdkConfig;
                var e;
                t = 0;
                for (var i in n.instance.sdkConfigCached) 0 === t && (e = i), ++t;
                return e && 0 < t ? n.instance.sdkConfigCached : n.instance.sdkConfigDefault
                ...
                e.category = n.CategorySdkError, e.sdk_version = o.getRelevantSdkVersion(), e.os_version = o.osVersion, e.manufacturer = o.deviceManufacturer, e.device = o.deviceModel, e.platform = o.buildPlatform;
                var i = o.getConnectionType();
                ...
                var e = {};
                return e.user_id = n.getIdentifier(), e.sdk_version = o.getRelevantSdkVersion(), e.os_version = o.osVersion, e.platform = o.buildPlatform, e
                ...
                if (o)
                    for (var u = 0; u < o.length; ++u) {
                        var d = o[u];
                        d && (e.progressionTries[d.progression] = d.tries)
                    }
                ...
                if (e) {
                    ...
                    for (var o in e) {
                        var a = e[o];
                        if (o && a)
                            if (s < n.MAX_CUSTOM_FIELDS_COUNT) {
                                var u = new RegExp("^[a-zA-Z0-9_]{1," + n.MAX_CUSTOM_FIELDS_KEY_LENGTH + "}$");
                                if (i.stringMatch(o, u)) {
                                    var d = typeof a;
                                    if ("string" === d || a instanceof String) {
                                        var c = a;
                                        c.length <= n.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH && 0 < c.length ? (t[o] = c, ++s) : r.w("validateAndCleanCustomFields: entry with key=" + o + ", value=" + a + " has been omitted because its value is an empty string or exceeds the max number of characters (" + n.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH + ")")
                                    } else if ("number" === d || a instanceof Number) {
                                        var l = a;
                                        t[o] = l, ++s
                                ...
                                } else r.w("validateAndCleanCustomFields: entry with key=" + o + ", value=" + a + " has been omitted because its key contains illegal character, is empty or exceeds the max number of characters (" + n.MAX_CUSTOM_FIELDS_KEY_LENGTH + ")")
                            } else r.w("validateAndCleanCustomFields: entry with key=" + o + ", value=" + a + " has been omitted because it exceeds the max number of custom fields (" + n.MAX_CUSTOM_FIELDS_COUNT + ")");
            ...
            }, n.isCommandCenterReady = function() {
                return n.instance.commandCenterIsReady
            }, n.addCommandCenterListener = function(e) {
                n.instance.commandCenterListeners.indexOf(e) < 0 && n.instance.commandCenterListeners.push(e)
            }, n.removeCommandCenterListener = function(e) {
                var t = n.instance.commandCenterListeners.indexOf(e); - 1 < t && n.instance.commandCenterListeners.splice(t, 1)
            }, n.getConfigurationsContentAsString = function() {
                    ...
                    for (var i = 0; i < t.length; ++i) {
                        ...
                        if (r) {
                            var s = r.key,
                                ...
                                u = r.end ? r.end : Number.MAX_VALUE,
                                d = n.getClientTsAdjusted();
                            s && o && a < d && d < u && (n.instance.configurations[s] = o)
                        }
                    }
                n.instance.commandCenterIsReady = !0;
                var c = n.instance.commandCenterListeners;
                for (i = 0; i < c.length; ++i) c[i] && c[i].onCommandCenterUpdated()
    ...
    function(e) {
        var n, t, i, r;
        n = e.tasks || (e.tasks = {}), t = e.utilities.GAUtilities, i = e.logging.GALogger, r = function() {
            function e() {}
    ...
    function(e) {
        var n, t, i, r, s, o, a;
        n = e.http || (e.http = {}), t = e.state.GAState, i = e.logging.GALogger, r = e.utilities.GAUtilities, s = e.validators.GAValidator, o = e.tasks.SdkErrorTask, a = function() {
            function e() {
                this.protocol = "https", this.hostName = "api.gameanalytics.com", this.version = "v2", this.baseUrl = this.protocol + "://" + this.hostName + "/" + this.version, this.initializeUrlPath = "init", this.eventsUrlPath = "events", this.useGzip = !1
            }
            return e.prototype.requestInit = function(i) {
                var r = t.getGameKey(),
                    s = (this.baseUrl, this.initializeUrlPath);
                s = "https://rubick.gameanalytics.com/v2/command_center?game_key=" + r + "&interval_seconds=1000000";
                var o = t.getInitAnnotations(),
                    a = JSON.stringify(o);
                if (a) {
                    var u = this.createPayloadData(a, this.useGzip),
                        d = [];
                    d.push(a), e.sendRequest(s, u, d, this.useGzip, e.initRequestCallback, i)
                } else i(n.EGAHTTPApiResponse.JsonEncodeFailed, null)
                ...
                if (0 != i.length) {
                    ...
                    var d = this.createPayloadData(u, this.useGzip),
                        c = [];
                    c.push(u), c.push(r), c.push(i.length.toString()), e.sendRequest(a, d, c, this.useGzip, e.sendEventInArrayRequestCallback, s)
                }
                ...
                if (t.isEventSubmissionEnabled()) {
                    ...
                    if (s.validateSdkErrorEvent(r, a, n)) {
                        var d, u = this.baseUrl + "/" + r + "/" + this.eventsUrlPath,
                ...
                void 0 === s && (s = null);
                var u, d, o = (s[0], s[1], s[2]),
                    a = parseInt(s[3]);
                u = t.responseText, d = t.status;
                var c = e.instance.processRequestResponse(d, t.statusText, u, "Events");
                if (c == n.EGAHTTPApiResponse.Ok || c == n.EGAHTTPApiResponse.BadRequest) {
                    var l = u ? JSON.parse(u) : {};
                    null != l ? (n.EGAHTTPApiResponse.BadRequest, r(c, l, o, a)) : r(n.EGAHTTPApiResponse.JsonDecodeFailed, null, o, a)
                } else r(c, null, o, a)
                ...
                var u = new XMLHttpRequest,
                    ...
                    c = r.getHmac(d, n),
                    l = [];
                for (var f in l.push(c), i) l.push(i[f]);
                if (u.onreadystatechange = function() {
                        4 === u.readyState && o(u, e, a, l)
                    }, u.open("POST", e, !0), u.setRequestHeader("Content-Type", "text/plain"), u.setRequestHeader("Authorization", c), s) throw new Error("gzip not supported");
                try {
                    u.send(n)
                } catch (e) {
                    console.error(e.stack)
                ...
                var d = a ? JSON.parse(a) : {},
                    c = e.instance.processRequestResponse(u, t.statusText, a, "Init");
                if (c == n.EGAHTTPApiResponse.Ok || c == n.EGAHTTPApiResponse.BadRequest)
                    if (null != d)
                        if (c !== n.EGAHTTPApiResponse.BadRequest) {
                            var l = s.validateAndCleanInitRequestResponse(d);
                            l ? r(n.EGAHTTPApiResponse.Ok, l, "", 0) : r(n.EGAHTTPApiResponse.BadResponse, null, "", 0)
                        } else r(c, null, "", 0);
                else r(n.EGAHTTPApiResponse.JsonDecodeFailed, null, "", 0);
                else r(c, null, "", 0)
    ...
    function(e) {
        var n, t, i, r, s, o, a, u, d, c, l, f;
        n = e.events || (e.events = {}), t = e.store.GAStore, i = e.store.EGAStore, r = e.store.EGAStoreArgsOperator, s = e.state.GAState, o = e.logging.GALogger, a = e.utilities.GAUtilities, u = e.http.EGAHTTPApiResponse, d = e.http.GAHTTPApi, c = e.validators.GAValidator, l = e.http.EGASdkErrorType, f = function() {
            function n() {}
            return n.addSessionStartEvent = function() {
            ...
            }, n.addBusinessEvent = function(e, i, r, a, u, f) {
                if (void 0 === u && (u = null), s.isEventSubmissionEnabled()) {
                    if (!c.validateBusinessEvent(e, i, u, r, a)) return void d.instance.sendSdkErrorEvent(l.Rejected);
                    var v = {};
            ...
            }, n.addResourceEvent = function(t, i, r, a, u, f) {
                if (s.isEventSubmissionEnabled()) {
                    if (!c.validateResourceEvent(t, i, r, a, u, s.getAvailableResourceCurrencies(), s.getAvailableResourceItemTypes())) return void d.instance.sendSdkErrorEvent(l.Rejected);
                    t === e.EGAResourceFlowType.Sink && (r *= -1);
                    var v = {},
                        g = n.resourceFlowTypeToString(t);
                    v.event_id = g + ":" + i + ":" + a + ":" + u, v.category = n.CategoryResource, v.amount = r, n.addDimensionsToEvent(v), n.addFieldsToEvent(v, s.validateAndCleanCustomFields(f)), o.i("Add RESOURCE event: {currency:" + i + ", amount:" + r + ", itemType:" + a + ", itemId:" + u + "}"), n.addEventToStore(v)
                }
            }, n.addProgressionEvent = function(t, i, r, a, u, f, v) {
                if (s.isEventSubmissionEnabled()) {
                    var g = n.progressionStatusToString(t);
                    if (!c.validateProgressionEvent(t, i, r, a)) return void d.instance.sendSdkErrorEvent(l.Rejected);
                    var m, p = {};
                    m = r ? a ? i + ":" + r + ":" + a : i + ":" + r : i, p.category = n.CategoryProgression, p.event_id = g + ":" + m;
                    var h = 0;
                    f && t != e.EGAProgressionStatus.Start && (p.score = u), t === e.EGAProgressionStatus.Fail && s.incrementProgressionTries(m), t === e.EGAProgressionStatus.Complete && (s.incrementProgressionTries(m), h = s.getProgressionTries(m), p.attempt_num = h, s.clearProgressionTries(m)), n.addDimensionsToEvent(p), n.addFieldsToEvent(p, s.validateAndCleanCustomFields(v)), o.i("Add PROGRESSION event: {status:" + g + ", progression01:" + i + ", progression02:" + r + ", progression03:" + a + ", score:" + u + ", attempt:" + h + "}"), n.addEventToStore(p)
                }
            }, n.addDesignEvent = function(e, t, i, r) {
                if (s.isEventSubmissionEnabled()) {
                    if (!c.validateDesignEvent(e, t)) return void d.instance.sendSdkErrorEvent(l.Rejected);
                    var a = {};
                    a.category = n.CategoryDesign, a.event_id = e, i && (a.value = t), n.addDimensionsToEvent(a), n.addFieldsToEvent(a, s.validateAndCleanCustomFields(r)), o.i("Add DESIGN event: {eventId:" + e + ", value:" + t + "}"), n.addEventToStore(a)
                }
            }, n.addErrorEvent = function(e, t, i) {
                if (s.isEventSubmissionEnabled()) {
                    var r = n.errorSeverityToString(e);
                    if (!c.validateErrorEvent(e, t)) return void d.instance.sendSdkErrorEvent(l.Rejected);
                    var a = {};
                    a.category = n.CategoryError, a.severity = r, a.message = t, n.addDimensionsToEvent(a), n.addFieldsToEvent(a, s.validateAndCleanCustomFields(i)), o.i("Add ERROR event: {severity:" + r + ", message:" + t + "}"), n.addEventToStore(a)
                }
                ...
                if (s.isEventSubmissionEnabled()) try {
                    ...
                    var f = [];
                    f.push(["status", r.Equal, "new"]), e && (l.push(["category", r.Equal, e]), f.push(["category", r.Equal, e]));
                    var v = [];
                    v.push(["status", c]);
                    var g = t.select(i.Events, l);
                    if (!g || 0 == g.length) return o.i("Event queue: No events to send"), void n.updateSessionStore();
                    if (g.length > n.MaxEventCount) {
                        if (!(g = t.select(i.Events, l, !0, n.MaxEventCount))) return;
                        var p = g[g.length - 1].client_ts;
                        if (l.push(["client_ts", r.LessOrEqual, p]), !(g = t.select(i.Events, l))) return;
                        f.push(["client_ts", r.LessOrEqual, p])
                    }
                    if (o.i("Event queue: Sending " + g.length + " events."), !t.update(i.Events, v, f)) return;
                    for (var h = [], S = 0; S < g.length; ++S) {
                        var y = g[S],
                            E = JSON.parse(a.decode64(y.event));
                        0 != E.length && h.push(E)
                    }
                    d.instance.sendEventsInArray(h, c, n.processEventsCallback)
                } catch (e) {
                    o.e("Error during ProcessEvents(): " + e.stack)
                }
            }, n.processEventsCallback = function(e, n, s, a) {
                var d = [];
                if (d.push(["status", r.Equal, s]), e === u.Ok) t.delete(i.Events, d), o.i("Event queue: " + a + " events sent.");
                else if (e === u.NoResponse) {
                    var c = [];
                    c.push(["status", "new"]), o.w("Event queue: Failed to send events to collector - Retrying next time"), t.update(i.Events, c, d)
                } else {
                    if (n) {
                        var l, f = 0;
                ...
                if (s.isEventSubmissionEnabled()) {
                    ...
                    if (u && 0 != u.length) {
                        ...
                        for (var d = 0; d < u.length; ++d) {
                            var c = JSON.parse(a.decode64(u[d].event)),
                                v = c.client_ts - u[d].timestamp;
                            v = Math.max(0, v), c.category = n.CategorySessionEnd, c.length = v, n.addEventToStore(c)
                        }
                    }
                }
                ...
                if (s.isEventSubmissionEnabled()) {
                    ...
                    try {
                        ...
                        f.category = u.category, f.session_id = u.session_id, f.client_ts = u.client_ts, f.event = a.encode64(JSON.stringify(u)), t.insert(i.Events, f), e.category == n.CategorySessionEnd ? t.delete(i.Sessions, [
                            ["session_id", r.Equal, u.session_id]
                        ]) : ((f = {}).session_id = u.session_id, f.timestamp = s.getSessionStart(), f.event = d, t.insert(i.Sessions, f, !0, "session_id")), t.isStorageAvailable() && t.save()
                    } catch (c) {
                        o.e("addEventToStore: error"), o.e(c.stack)
                    }
                }
    ...
    function(e) {
        var n, t, i, r, s;
        n = e.threading || (e.threading = {}), t = e.logging.GALogger, i = e.state.GAState, r = e.events.GAEvents, s = function() {
            function e() {
            ...
            return e.createTimedBlock = function(e) {
                ...
                0 < n && (e.ProcessEventsIntervalInSeconds = n)
        ...
        var n = e.threading.GAThreading,
            ...
            l = function() {
                ...
                return l.init = function() {
                    ...
                    0 < n.length && n[0] in e.GameAnalytics.methodMap && (1 < n.length ? e.GameAnalytics.methodMap[n[0]].apply(null, Array.prototype.slice.call(n, 1)) : e.GameAnalytics.methodMap[n[0]]())
                    ...
                    if (e === u.Ok && s) {
                        ...
                        s.time_offset = o, i.setItem(r.SdkConfigCachedKey, d.encode64(JSON.stringify(s))), r.instance.sdkConfigCached = s, r.instance.sdkConfig = s, r.instance.initAuthorized = !0
                    ...
                    var f = d.createGuid();
                    r.instance.sessionId = f, r.instance.sessionStart = r.getClientTsAdjusted(), c.addSessionStartEvent();
    ...
    scope.gameanalytics = gameanalytics, scope.GameAnalytics = GameAnalytics
}(this);
var loaderHelper = {
        show: function() {
    ...
    flambe = {
        ...
        embed: function(k, w) {
            ...
            for (p = r.flambe, h = 0; h < k.length; ++h) switch (r = k[h], (n = r.match(/\.(\w+)(\?|$)/)) && (n = n[1].toLowerCase()), n) {
                case "swf":
                    if ((null == p || "flash" == p) && swfobject.hasFlashPlayerVersion(flambe.FLASH_VERSION)) return (h = document.createElement("div")).id = w + "-swf", x.appendChild(h), "undefined" == typeof $flambe_expose && (window.$flambe_expose = function(h, n) {
                    ...
                    break;
                case "js":
                    if ((null == p || "html" == p) && "getContext" in (n = document.createElement("canvas"))) return n.id = w + "-canvas", x.appendChild(n), flambe.canvas = n, (h = document.createElement("script")).onload = function() {
                        flambe.canvas = null
    ...
    swfobject = function() {
        function k() {
            if (!y) {
                try {
                    (a = d.getElementsByTagName("body")[0].appendChild(d.createElement("span"))).parentNode.removeChild(a)
                } catch (b) {
                    return
                }
                y = !0;
        ...
        function x(a) {
            ...
            else if (typeof l.attachEvent != j) ! function(a, b, c) {
                a.attachEvent(b, c), A[A.length] = [a, b, c]
            }(l, "onload", a);
        ...
        function p() {
            ...
            if (0 < a)
                for (var b = 0; b < a; b++) {
                    ...
                    if (0 < e.pv[0]) {
                        if (d = q(c))
                            if (!E(u[b].swfVersion) || e.wk && e.wk < 312)
                                if (u[b].expressInstall && n()) {
                                    (g = {}).data = u[b].expressInstall, g.width = d.getAttribute("width") || "0", g.height = d.getAttribute("height") || "0", d.getAttribute("class") && (g.styleclass = d.getAttribute("class")), d.getAttribute("align") && (g.align = d.getAttribute("align"));
                                    for (var d, i = {}, o = (d = d.getElementsByTagName("param")).length, m = 0; m < o; m++) "movie" != d[m].getAttribute("name").toLowerCase() && (i[d[m].getAttribute("name")] = d[m].getAttribute("value"));
                                    I(g, i, c, f)
                                } else U(d), f && f(g);
                        else z(c, !0), f && (g.success = !0, g.ref = h(c), f(g))
                    } else z(c, !0), f && ((c = h(c)) && typeof c.SetVariable != j && (g.success = !0, g.ref = c), f(g))
                }
        }

        function h(a) {
            var b = null;
            return (a = q(a)) && "OBJECT" == a.nodeName && (typeof a.SetVariable != j ? b = a : (a = a.getElementsByTagName(s)[0]) && (b = a)), b
        }

        function n() {
            return !F && E("6.0.65") && (e.win || e.mac) && !(e.wk && e.wk < 312)
        }
        ...
        function J(a) {
            ...
            else if ((a = a.getElementsByTagName(s)[0]) && (a = a.childNodes))
        ...
        function L(a, b, c) {
            ...
            if (g)
                if (typeof a.id == j && (a.id = c), e.ie && e.win) {
                    var i, h = "";
                    for (i in a) a[i] != Object.prototype[i] && ("data" == i.toLowerCase() ? b.movie = a[i] : "styleclass" == i.toLowerCase() ? h += ' class="' + a[i] + '"' : "classid" != i.toLowerCase() && (h += " " + i + '="' + a[i] + '"'));
                    for (var o in i = "", b) b[o] != Object.prototype[o] && (i += '<param name="' + o + '" value="' + b[o] + '" />');
                    g.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + h + ">" + i + "</object>", H[H.length] = a.id, f = q(a.id)
                } else {
                    for (var m in (o = d.createElement(s)).setAttribute("type", D), a) a[m] != Object.prototype[m] && ("styleclass" == m.toLowerCase() ? o.setAttribute("class", a[m]) : "classid" != m.toLowerCase() && o.setAttribute(m, a[m]));
                    for (h in b) b[h] != Object.prototype[h] && "movie" != h.toLowerCase() && (a = o, m = b[i = h], (c = d.createElement("param")).setAttribute("name", i), c.setAttribute("value", m), a.appendChild(c));
                    g.parentNode.replaceChild(o, g), f = o
                } return f
        }
        ...
        function E(a) {
            var b = e.pv;
            return (a = a.split("."))[0] = parseInt(a[0], 10), a[1] = parseInt(a[1], 10) || 0, a[2] = parseInt(a[2], 10) || 0, b[0] > a[0] || b[0] == a[0] && b[1] > a[1] || b[0] == a[0] && b[1] == a[1] && b[2] >= a[2]
        }

        function Q(a, b, c, f) {
            if (!e.ie || !e.mac) {
                var g = d.getElementsByTagName("head")[0];
                g && (c = c && "string" == typeof c ? c : "screen", f && (M = t = null), t && M == c || ((f = d.createElement("style")).setAttribute("type", "text/css"), f.setAttribute("media", c), t = g.appendChild(f), e.ie && e.win && typeof d.styleSheets != j && 0 < d.styleSheets.length && (t = d.styleSheets[d.styleSheets.length - 1]), M = c), e.ie && e.win ? t && typeof t.addRule == s && t.addRule(a, b) : t && typeof d.createTextNode != j && t.appendChild(d.createTextNode(a + " {" + b + "}")))
            }
        }
        ...
        var B, G, K, N, t, M, j = "undefined",
                ...
                T ? function() {
                    ...
                    if (c) {
                        ...
                        ! function() {
                            ...
                            } else if (f < 10) return f++, setTimeout(arguments.callee, 10);
                            a.removeChild(b), c = null, p()
                        }()
                    } else p()
                }() : p()
            }],
            ...
            e = function() {
                var a = typeof d.getElementById != j && typeof d.getElementsByTagName != j && typeof d.createElement != j,
                    ...
                    f = /win/.test(c || b),
                    g = (c = /mac/.test(c || b), b = !!/webkit/.test(b) && parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")), !1),
                    e = [0, 0, 0],
                    i = null;
                if (typeof v.plugins != j && typeof v.plugins["Shockwave Flash"] == s) !(i = v.plugins["Shockwave Flash"].description) || typeof v.mimeTypes != j && v.mimeTypes[D] && !v.mimeTypes[D].enabledPlugin || (g = !(T = !0), i = i.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), e[0] = parseInt(i.replace(/^(.*)\..*$/, "$1"), 10), e[1] = parseInt(i.replace(/^.*\.(.*)\s.*$/, "$1"), 10), e[2] = /[a-zA-Z]/.test(i) ? parseInt(i.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
                else if (typeof l.ActiveXObject != j) try {
                    var h = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
                    h && (i = h.GetVariable("$version")) && (g = !0, i = i.split(" ")[1].split(","), e = [parseInt(i[0], 10), parseInt(i[1], 10), parseInt(i[2], 10)])
                } catch (m) {}
                return {
                    w3: a,
                    pv: e,
        ...
        return e.w3 && ((typeof d.readyState != j && "complete" == d.readyState || typeof d.readyState == j && (d.getElementsByTagName("body")[0] || d.body)) && k(), y || (typeof d.addEventListener != j && d.addEventListener("DOMContentLoaded", k, !1), e.ie && e.win && (d.attachEvent("onreadystatechange", function() {
        ...
        }(), x(k))), e.ie && e.win && window.attachEvent("onunload", function() {
            for (var a = A.length, b = 0; b < a; b++) A[b][0].detachEvent(A[b][1], A[b][2]);
            for (a = H.length, b = 0; b < a; b++) P(H[b]);
            for (var c in e) e[c] = null;
            for (var f in e = null, swfobject) swfobject[f] = null;
            swfobject = null
        }), {
            registerObject: function(a, b, c, f) {
                if (e.w3 && a && b) {
                    var d = {};
                    d.id = a, d.swfVersion = b, d.expressInstall = c, d.callbackFn = f, u[u.length] = d, z(a, !1)
                } else f && f({
                    success: !1,
                    id: a
                })
            ...
            embedSWF: function(a, b, c, d, g, h, i, o, m, k) {
                ...
                e.w3 && !(e.wk && e.wk < 312) && a && b && c && d && g ? (z(b, !1), w(function() {
                    c += "", d += "";
                    var e = {};
                    if (m && typeof m === s)
                        for (var l in m) e[l] = m[l];
                    if (e.data = a, e.width = c, e.height = d, l = {}, o && typeof o === s)
                    ...
                    if (E(g)) q = L(e, l, b), e.id == b && z(b, !0), p.success = !0, p.ref = q;
                        ...
                        if (h && n()) return e.data = h, void I(e, l, b, k);
                        z(b, !0)
                    }
                    k && k(p)
                })) : k && k(p)
            ...
            getQueryParamValue: function(a) {
                if (b = d.location.search || d.location.hash) {
                    if (/\?/.test(b) && (b = b.split("?")[1]), null == a) return S(b);
            ...
            expressInstallCallback: function() {
                if (F) {
                    var a = q(O);
                    a && B && (a.parentNode.replaceChild(B, a), G && (z(G, !0), e.ie && e.win && (B.style.display = "block")), K && K(N)), F = !1
                }
            }
        }
    }();